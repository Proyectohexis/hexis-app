  ...
  return (
    <View style={styles.container}>
      <View style={styles.top}>
        ...
        <Text style={styles.subtitle}>Crea tu cuenta y empieza tu transformacion.</Text>
      </View>
      ...
      <View style={styles.form}>
        ...
        <TouchableOpacity
          ...
          disabled={loading}
        >
          {loading ? <ActivityIndicator color={colors.text.primary} /> : <Text style={styles.buttonText}>Crear cuenta</Text>}
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: typography.sizes.sm, color: colors.text.secondary, textAlign: 'center' },
